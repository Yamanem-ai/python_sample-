...
def initialize():
    ...
    bert_tokenizer = (
        ...
        .from_pretrained(
            dict_path="unidic-lite",
            pretrained_model_name_or_path=
            "./tokenizer/deberta-v2-large-japanese-char-wwm"
        )
    )
...
def tts(
    ...
    phones, tones, lang_ids, bert, sid, emo_embed = (
        prepare_inputs(
            text,
            style_text,
            sid,
            ...
            emo_audio_path,
            _models["bert"],
            _models["bert_tokenizer"],
            _models["clap"],
            _models["clap_tokenizer"],
            _models["clap_audio"]
        )
    )
