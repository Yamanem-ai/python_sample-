...
import ap_10k_ex as pose_ex   # ← ここ重要
...
def main():
    ...
    net, det_net = pose_ex.create_models()
    ...
    while True:
        ...
        # ======================
            ...
            results = pose_ex.infer_frame(net, det_net, frame)
            display = pose_ex.draw_pose(display, results)
